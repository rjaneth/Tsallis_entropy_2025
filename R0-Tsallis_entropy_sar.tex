...
al.~\citeproc{ref-Ebrahimi1994}{{[}27{]}} for the Shannon entropy, and
...
to detect deviations from fully-developed speckle in SAR images. The
...
accuracy, showed that the adaptive Tsallis-based configuration

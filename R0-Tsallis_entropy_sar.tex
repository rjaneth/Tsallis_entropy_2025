...
\hypersetup{
  pdftitle={Adaptive Nonparametric Tsallis Entropy Estimation for Detecting Non-Fully-Developed Speckle},
...
% can use linebreaks \\ within to get better formatting as desired
% Do not put math or special symbols in the title.
\title{Adaptive Nonparametric Tsallis Entropy Estimation for Detecting

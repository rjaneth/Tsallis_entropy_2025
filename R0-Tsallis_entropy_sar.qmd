...
The selected SAR scenes were acquired in HH polarization for the outskirts of Munich (Germany) and Dublin Port (Ireland), and in VV polarization for Foggia (Italy), as shown in Figs.&nbsp;\ref{fig:munich-sar}–\ref{fig:foggia-sar}. 
The corresponding optical images (Figs.&nbsp;\ref{fig:munich-o}–\ref{fig:foggia-o}) illustrate the land cover context.

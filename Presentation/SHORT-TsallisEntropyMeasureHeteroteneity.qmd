...
distribution and incorporates $\alpha<0$, whose absolute value is proportional
to $m$, the number of backscatterers:
\begin{multline}    
...
Our [model-free]{.alert} estimator of $T_\lambda$ 
$$

...
For simplicity, our reply will focus on discrete probabilities.
...
meaning [\dots].
\end{quote}
In line with this work, we used grid search to find the optimal value of $q$ for our problem and found that $q=0.85$ yielded the smallest bias and mean squared error in all but one case.
...
\textcolor{red}{Decidir qué poner en el artículo}
\end{responsebox}
...
\textcolor{red}{Decidir qué se pone en el artículo.}
